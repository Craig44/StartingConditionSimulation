#'
#' Show all the F's for the fast biology run
...
fig_dir = file.path(DIR$fig, "FastBiology")
...
plot(years, fish_100_50, type = "l", lty = 2, lwd = 2, ylim = c(0,0.35), ylab = "", xlab = "", main = "100% initial depletion")
...
plot(years, fish_75_50, type = "l", lty = 2, lwd = 2, ylim = c(0,0.35), ylab = "", xlab = "Years", main = "75% initial depletion")
lines(years, fish_75_35, col = "red", lty = 2, lwd = 2)
lines(years, fish_75_20, col = "blue", lty = 2, lwd = 2)

plot(years, fish_50_50, type = "l", lty = 2, lwd = 2, ylim = c(0,0.35), ylab = "", xlab = "", main = "50% initial depletion")
lines(years, fish_50_35, col = "red", lty = 2, lwd = 2)
lines(years, fish_50_20, col = "blue", lty = 2, lwd = 2)

plot(years, fish_25_50, type = "l", lty = 2, lwd = 2, ylim = c(0,0.35), ylab = "", xlab = "", main = "25% initial depletion")
